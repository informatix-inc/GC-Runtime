...
MachOper *indPosIndexOffsetOper::clone(Compile* C) const {
  return new (C) indPosIndexOffsetOper(_c0);
}
...
MachOper *indPosIndexOffsetNarrowOper::clone(Compile* C) const {
  return new (C) indPosIndexOffsetNarrowOper(_c0);
}
