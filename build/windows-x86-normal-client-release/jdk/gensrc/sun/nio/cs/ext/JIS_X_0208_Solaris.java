                        ...
                        implements HistoricallyNamedCharset
{
    public JIS_X_0208_Solaris() {
        ...
        public String historicalName() { return "JIS0208_Solaris"; }
    ...
    public CharsetDecoder newDecoder() {
        initb2c();
        return new  DoubleByte.Decoder_DBCSONLY(this, b2c, b2cSB, 0x21, 0x7e);
    }

    public CharsetEncoder newEncoder() {
        initc2b();
        return new DoubleByte.Encoder_DBCSONLY(this, new byte[]{ (byte)0x21, (byte)0x29 }, c2b, c2bIndex); 
    }
