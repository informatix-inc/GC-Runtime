...
CUT="/usr/bin/cut"
DIFF="/usr/bin/diff"
DUMPBIN="/cygdrive/c/cygwin64/home/fujimoto/openjdk-jdk8u/build/windows-x86-normal-client-release/fixpath.exe -c /cygdrive/c/progra~2/micros~1.0/vc/bin/dumpbin"
EXPR="/usr/bin/expr"
FILE="/usr/bin/file"
FIND="/usr/bin/find"
GREP="/usr/bin/grep"
JAVAP="/cygdrive/c/cygwin64/home/fujimoto/openjdk-jdk8u/build/windows-x86-normal-client-release/fixpath.exe -c /cygdrive/c/AdoptOpenJDK/prerequisite/jdk7/bin/javap"
LDD="/usr/bin/ldd"
MKDIR="/usr/bin/mkdir"
NAWK="/usr/bin/gawk"
NM=""
